...
GROUPS: List[Group] = [
    ...
    (
        ...
        [
            ...
            ("chat_open <peer> <msg...>", "start a new conversation with a peer"),
            ("chat_reply <id> <msg...>", "reply in an existing conversation"),
            ("chat_threads [<peer>]", "list conversations, open and closed"),
            ("chat_thread <id>", "show one conversation's messages"),
            ("chat_close <id>", "close a conversation (local only)"),
            ("chat_reopen <id>", "reopen a closed conversation"),
