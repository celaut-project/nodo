...
$KernelUrl = "https://github.com/celaut-project/nodo/releases/download/wsl-exe/bzImage"
$NodoBaseDir = "C:\WSL\Nodo"
$NodoImageDir = "C:\WSL\Images"
$NodoRootfsPath = Join-Path $NodoImageDir "debian-nodo.tar"
$NodoRootfsUrl = "https://github.com/celaut-project/nodo/releases/download/wsl-exe/debian.tar"
...
mkdir -p /boot
curl -sSL https://github.com/celaut-project/nodo/releases/download/wsl-exe/vmlinuz -o /boot/vmlinuz
curl -sSL https://github.com/celaut-project/nodo/releases/download/wsl-exe/initramfs -o /boot/initramfs
